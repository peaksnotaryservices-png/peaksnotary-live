          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="bg-emerald-600 hover:bg-emerald-500 transition px-8 py-4 rounded-2xl font-semibold text-lg shadow-lg">
                  Request Appointment
                </button>

                <button className="border border-stone-700 hover:border-stone-500 transition px-8 py-4 rounded-2xl font-semibold text-lg">
                  View Pricing
                </button>
              </div>
            </div>
